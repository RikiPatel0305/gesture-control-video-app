...
public class MainActivity2 extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String uripath1="android.resource://com.example.videoapp/"+R.raw.tulipsscreen;
    ...
    public boolean onFling(MotionEvent downEvent, MotionEvent moveEvent, float velocityX, float velocityY) {
        ...
        else
        {
            ...
            if(Math.abs(diffY)>SWIPE_THRESHOLD && Math.abs(velocityY)>VELOCITY_THRESHOLD)
            {
                ...
                {
                    //swipe down
                    Intent intent=new Intent(MainActivity2.this,com.example.videoapp.MainActivity.class);
                    startActivity(intent);
                ...
                {
                    //swipe up
                    Intent intent=new Intent(MainActivity2.this,com.example.videoapp.MainActivity3.class);
                    startActivity(intent);
