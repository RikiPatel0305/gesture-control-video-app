...
public class MainActivity5 extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String uripath1="android.resource://com.example.videoapp/"+R.raw.parkboat;
...
//    }
    ...
    public boolean onFling(MotionEvent downEvent, MotionEvent moveEvent, float velocityX, float velocityY) {
        ...
        else
        {
            ...
            if(Math.abs(diffY)>SWIPE_THRESHOLD && Math.abs(velocityY)>VELOCITY_THRESHOLD)
            {
                ...
                {
                    //swipe down
                    Intent intent=new Intent(MainActivity5.this,com.example.videoapp.MainActivity4.class);
                    startActivity(intent);
                ...
                {
                    //swipe up
                    Intent intent=new Intent(MainActivity5.this,com.example.videoapp.MainActivity.class);
                    startActivity(intent);
    ...
    private void onSwipeRight() {
        Intent intent=new Intent(MainActivity5.this,com.example.videoapp.Main2Activity5.class);
        startActivity(intent);
